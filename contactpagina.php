    ...
    <div class="main">
      <div class="contact_area">
        ...
        <form action="/" method="POST" class="form">
          ...
          <div class="input"><input type="text" id="voornaam" name="voornaam" placeholder="Voornaam" required></div><br>

          <label class="omschrijving" for="tv">Tussenvoegsel (optioneel):</label>
          <div class="input"><input type="text" id="tv" name="tv" placeholder="Tussenv." size="20"></div><br>

          <label class="omschrijving" for="achternaam">Achternaam:</label>
          <div class="input"><input type="text" id="achternaam" name="achternaam" placeholder="Achternaam" required>
          </div><br>

          <label class="omschrijving" for="email">E-mailadres:</label>
          <div class="input"><input type="email" id="email" name="email" placeholder="random@gmail.com"
              pattern="[a-z0-9.%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required></div><br>

          <label class="omschrijving" for="telnummer">Telefoonnummer:</label>
          <div class="input"><input type="tel" id="telnummer" name="telnummer" pattern="[0-9]{5,20}"
              placeholder="Telefoonnummer"></div><br>

          <label class="omschrijving" for="geboorte_datum">Geboortedatum:</label>
          <div class="input"><input type="date" id="geboorte_datum" name="geboorte_datum"></div><br>

          <label class="omschrijving groot" for="omschrijving">Opmerkingen?</label>
          <div class="input"><textarea id="omschrijving" name="omschrijving">Hou rekening met...</textarea></div><br>
          ...
          <input type="submit" class="neonbut" value="Verzenden">
        </form>
